...
def data_loader_func(batch_sizes, path_to_dataset):
    ...
    teacher_train_set = dataset.cifar10.CIFAR10(root=path_to_dataset, transform=transform_train, split='teacher_train')
    ...
    student_train_set = dataset.cifar10.CIFAR10(root=path_to_dataset, transform=transform_train, split='student_train')
