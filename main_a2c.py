        ...
        while True:
            ...
            for idx, (inputs, labels) in enumerate(dataloader['teacher_train_loader']):
                ...
                if count_sampled >= config['M']:
                    ...
                    writer.add_scalars('train_l2t/rain', {'train_loss': train_loss, 'train_acc': train_acc},
                    ...
                    if student_updates % (config['rollout_length']+1) == 0:
                        ...
                        writer.add_scalar('policy_loss', policy_loss, teacher_updates)
                        writer.add_scalar('value_loss', value_loss, teacher_updates)
                        writer.add_scalar('entropy_loss', entropy_loss, teacher_updates)
                        writer.add_scalar('return', returns.mean(), teacher_updates)
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('./runs/a2c')

    print('Training the teacher starts....................')
    # train_l2t()

    model_save_dir = './result/a2c/teacher'
    ...
    test_l2t()
    model_save_dir = './result/a2c/student'
    if not os.path.exists(model_save_dir):
        os.makedirs(model_save_dir)
