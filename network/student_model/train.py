...
if __name__ == '__main__':
    ...
    start_time = time.time()
    model = train(model, criterion, optimizer, exp_lr_scheduler, writer, dataloader['teacher_train_loader'],
                  dataloader['dev_loader'], start_epoch, args.epochs)
    end_time = time.time()
    ...
    start_time = time.time()
    test(model, dataloader['test'], dataloader['classes'])
    end_time = time.time()
